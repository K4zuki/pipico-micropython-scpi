...
scpi_commands = [
    ...
    "I2C0:ADDRess:BIT?", "I2C0:ADDRess:BIT 0", "I2C0:ADDRess:BIT 1", "I2C0:ADDRess:BIT DEFault",
    "I2C1:ADDRess:BIT?", "I2C1:ADDRess:BIT 0", "I2C1:ADDRess:BIT 1", "I2C1:ADDRess:BIT DEFault",
...
with serial.Serial(port=port, baudrate=1_000_000, timeout=0.1) as s:
    for command in scpi_commands:
        ...
        time.sleep(0.01)
        lines = s.readlines()
        print("".join([line.decode("utf8") for line in lines]))
